...
erro=$(echo -e "\033[31m[ERRO]\033[0m $(date "+%Y-%m-%d %H:%M:%S") - ${sh_name}:")
info=$(echo -e "\033[32m[INFO]\033[0m $(date "+%Y-%m-%d %H:%M:%S") - ${sh_name}:")
warn=$(echo -e "\033[33m[WARN]\033[0m $(date "+%Y-%m-%d %H:%M:%S") - ${sh_name}:")
